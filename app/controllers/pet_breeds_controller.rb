class PetBreedsController < ApplicationController
  ...
  private
    ...
    def pet_breed_params
      params.require(:pet_breed).permit(:pet_id, :breed_id, :saved_pets_user_email, :saved_pets_pet_id,
      :saved_pets_users_user_email,  :saved_pets_pets_pet_id, :saved_pets_businesses_business_id, 
      :BREED_breed_id)
    end
end
